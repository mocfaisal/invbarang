...
<table class="table" id="data-alert">
	<thead>
		<tr>
			<th>No.</th>
			<th>ID Peminjam</th>
...
echo "<td>".anchor('laporan/cetakalert/'.$data['pb_id'],'<span class="cetakalert"><button class="btn btn-success">Cetak</button></span>','target="_blank"')."</td>";
echo "</tr>";
$i++;
}
}
